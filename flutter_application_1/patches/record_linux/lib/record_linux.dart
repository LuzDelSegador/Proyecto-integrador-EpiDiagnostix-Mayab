...
class RecordLinux extends RecordPlatform {
  ...
  // FIX: added {bool request = true} to match record_platform_interface 1.6.0
  @override
  ...
  // FIX: added startStream stub to implement RecordMethodChannelPlatformInterface
  @override
  ...
  InputDevice? _extractDevice(String firstLine, {String? secondLine}) {
    final match =
        RegExp(r'(?:.*device #)(\d+): (\w.+)').firstMatch(firstLine);
